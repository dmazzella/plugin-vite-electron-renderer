 ...
 */
export const log = {
  info: (message: string) => console.log(`${colors.gray}${LOG_TAG}${colors.reset} ${message}`),
  success: (message: string) => console.log(`${colors.gray}${LOG_TAG}${colors.reset} ${colors.green}${message}${colors.reset}`),
  warn: (message: string) => console.log(`${colors.gray}${LOG_TAG}${colors.reset} ${colors.yellow}${message}${colors.reset}`),
  error: (message: string) => console.error(`${colors.gray}${LOG_TAG}${colors.reset} ${colors.red}${message}${colors.reset}`),
  module: (action: string, moduleName: string) => 
    console.log(`${colors.gray}${LOG_TAG}${colors.reset} ${colors.cyan}${action}${colors.reset} ${colors.yellow}${moduleName}${colors.reset}`),
}
 ...
 */
export function getModuleFilename(moduleName: string, extension: string = '.mjs'): string {
