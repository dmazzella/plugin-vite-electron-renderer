 ...
 */
function configureCommonJsIgnore(buildConfig: BuildOptions, modules: string[]): void {
 ...
 */
export function excludeFromOptimize(config: UserConfig, modules: string[]): void {
  config.optimizeDeps ??= {}
